...
<main class="dashboard-content">
    ...
    <div class="container-fluid px-3 px-lg-4 py-4">
            ...
            <div class="page-heading-copy d-flex align-items-center gap-3 section-title">
                ...
                <div>
                    ...
                    <p class="text-muted mb-0" style="font-size: 0.9rem;">
                        Mise à jour des données de l'inspection pesage.
                    </p>
        ...
        <form method="POST" action="{{ route('inspections.pesages.update', $inspection) }}">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text"
                                   ...
                                   value="{{ old('instrument', $pesage->instrument) }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text"
                                   ...
                                   class="form-control form-control-sm rounded-3"
                                   style="border-color: #e9ecef;"
                                   value="{{ old('marque', $pesage->marque) }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text"
                                   ...
                                   class="form-control form-control-sm rounded-3"
                                   style="border-color: #e9ecef;"
                                   value="{{ old('numero_serie', $pesage->numero_serie) }}"
                        ...
                        <div class="col-12 col-md-3">
                            ...
                            <input type="number"
                                   ...
                                   class="form-control form-control-sm rounded-3"
                                   style="border-color: #e9ecef;"
                                   value="{{ old('portee_max', $pesage->portee_max) }}"
                                   placeholder="0.000">
                        ...
                        <div class="col-12 col-md-3">
                            ...
                            <input type="number"
                                   ...
                                   class="form-control form-control-sm rounded-3"
                                   style="border-color: #e9ecef;"
                                   value="{{ old('portee_min', $pesage->portee_min) }}"
                                   placeholder="0.000">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text"
                                   ...
                                   class="form-control form-control-sm rounded-3"
                                   style="border-color: #e9ecef;"
                                   value="{{ old('echelon_verification', $pesage->echelon_verification) }}"
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text"
                                   ...
                                   class="form-control form-control-sm rounded-3"
                                   style="border-color: #e9ecef;"
                                   value="{{ old('echelon_affichage', $pesage->echelon_affichage) }}"
                                   placeholder="Ex : 0.001 g">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="number"
                                   ...
                                   class="form-control form-control-sm rounded-3"
                                   style="border-color: #e9ecef;"
                                   value="{{ old('annee_fabrication', $pesage->annee_fabrication) }}"
                                   placeholder="AAAA"
                                   min="1900"
                                   max="{{ date('Y') }}">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <input type="text"
                                   ...
                                   class="form-control form-control-sm rounded-3"
                                   style="border-color: #e9ecef;"
                                   value="{{ old('numero_approbation_modele', $pesage->numero_approbation_modele) }}"
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="infractions_constatees"
                                      ...
                                      class="form-control form-control-sm rounded-3"
                                      style="border-color: #e9ecef;"
                                      placeholder="Listez les infractions éventuelles...">{{ old('infractions_constatees', $pesage->infractions_constatees) }}</textarea>
