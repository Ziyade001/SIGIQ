    ...
    <div class="container-fluid px-3 px-lg-4 py-4">
            ...
            <div class="page-heading-copy d-flex align-items-center gap-3 section-title">
                ...
                <div>
                    ...
                    <p class="text-muted mb-0" style="font-size: 0.9rem;">
                        Planification d'une mission d'inspection sur le terrain.
                    </p>
        ...
        <form action="{{ route('missions.store') }}" method="POST">
            ...
            <div class="row g-4">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <select name="type_mission"
                                        ...
                                        @foreach ($typesMission as $type)
                                            <option value="{{ $type }}"
                                                {{ old('type_mission') == $type ? 'selected' : '' }}>
                                                {{ $type }}
                                            </option>
                                        @endforeach
                                    ...
                                    <select name="conducteur_cva"
                                        ...
                                        @foreach ($conducteurs as $conducteur)
                                            <option value="{{ $conducteur }}"
                                                {{ old('conducteur_cva') == $conducteur ? 'selected' : '' }}>
                                                {{ $conducteur }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="activites"
                                              ...
                                              class="form-control form-control-sm rounded-3"
                                              style="border-color: #e9ecef;"
                                              placeholder="Décrivez les activités prévues durant la mission...">{{ old('activites') }}</textarea>
                ...
                <!-- COLONNE DROITE : PARTICIPANTS + RÉSUMÉ -->
                            ...
                            <select name="chef_equipe"
                                ...
                                @foreach($inspecteurs as $inspecteur)
                                    ...
                                    <option value="{{ $inspecteur->id }}"
                                        {{ old('chef_equipe') == $inspecteur->id ? 'selected' : '' }}>
                                        {{ $inspecteur->name }}
                                    </option>
